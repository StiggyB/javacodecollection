...
enum timer_section {
	BEGIN_TO_HEIGH_MEASURE,
	HEIGH_MEASURE_TO_METAL_MEASURE,
	METAL_MEASURE_TO_SLIDE,
	METAL_MEASURE_TO_END,
	SWITCH_FORWARD_TIME
};
...
public:
	...
	bool addTimerFunction( CallInterface<CallBackThrower, void>* funcp, int timer );
