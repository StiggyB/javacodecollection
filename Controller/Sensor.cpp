...
void Sensor::handleNormalMessage() {
	...
	case INTERRUPT_D_PORT_C_HIGH:
		reactOnPortCHigh(val);
		break;
	case INTERRUPT_D_SERIAL:
		reactOnSerialCommand(val);
		break;
	case INTERRUPT_D_PORT_B:
		reactOnPortPortB(val);
		break;
	}//switch
...
void reactOnSerialCommand(int val){
